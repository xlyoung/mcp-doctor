...
_REGISTRY: list[dict[str, Any]] = [
    ...
    {"name": "mcp-server-puppeteer", "repo": "modelcontextprotocol/servers", "category": "web", "stars": 12000, "score": 85, "description": "Browser automation via Puppeteer", "lang": "typescript"},
